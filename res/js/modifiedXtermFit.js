...
var FitAddon = (function () {
    function FitAddon(parentSizeNode) {
        this.parentSizeNode = parentSizeNode;
    }
    ...
    FitAddon.prototype.proposeDimensions = function () {
        ...
        //console.log(this.parentSizeNode.getBoundingClientRect());
        var parentElementHeight = parseInt(this.parentSizeNode.clientHeight);
